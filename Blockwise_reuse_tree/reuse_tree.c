...
// int.dblp.txt
// ------------------------------------------------
// #define THRESHOLD 0.016364 // 1000
// #define THRESHOLD 0.003202 // 1000 * 10
// #define THRESHOLD 0.004252 // 1000 * 100
// #define THRESHOLD 0.005720 // 1000 * 1000
// #define THRESHOLD 0.002119 // 1000 * 1000 * 10
// #define THRESHOLD 0.000128 // 1000 * 1000 * 100
...
// #define THRESHOLD 0.000053 // 1000 * 1000 * 100

// int.protein.txt
// ------------------------------------------------
// #define THRESHOLD 0.035066 // 1000 
// #define THRESHOLD 0.012575 // 1000 * 10
// #define THRESHOLD 0.007914 // 1000 * 100
// #define THRESHOLD 0.012850 // 1000 * 1000
// #define THRESHOLD 0.005670 // 1000 * 1000 * 10
 #define THRESHOLD 0.001746 // 1000 * 1000 * 100
...
// distance between two frequency vectors
...
int main(int argc, char **argv)
{
    ...
    for (int block_index = 0; block_index < total_blocks; block_index++)
    {
        ...
        if (block_index % print_interval == 0)
        {
            ...
            if (block_index > 0)
                printf(are_equal(huffman_trees[block_index], huffman_trees[block_index - 1]) ? "Huffman tree is reused\n"
    ...
    fflush(stdout);
    printf("\033[0m");
    printf("Average cosine distance: %f\n", dist_cum / total_blocks);
    fflush(stdout);
